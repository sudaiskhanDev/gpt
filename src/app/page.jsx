  ...
  return (
   ...
   <Header />
    <div className="min-h-screen flex items-center justify-center p-6 text-gray-800 font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 bg-black backdrop-blur-lg shadow-2xl rounded-2xl p-10 max-w-4xl w-full space-y-10 transition-all duration-500 hover:scale-[1.01]">
